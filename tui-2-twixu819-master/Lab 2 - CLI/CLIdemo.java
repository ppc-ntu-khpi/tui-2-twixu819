...
public class CLIdemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            com.mybank.data.DataSource dataSource = new com.mybank.data.DataSource("tui-2-twixu819-master/data/test.dat");
            dataSource.loadData();
            fileLoaded = true;
        } catch (Exception e) {
            System.out.println(ANSI_RED + "WARNING! Cannot load bank database from file. Using default data." + ANSI_RESET);
        }
